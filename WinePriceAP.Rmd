...
result <- data.frame(Method = "Method",
                     RMSE = RMSE = RMSE(mu, test_dat$price))

result
```
The RMSE baseline is rather substantial, however this is expected. The price range for the wines are large and there are rare wines that are drastically more expensive than the average wine. Let's factor in the biases to see how that affects the RMSE.
